...
<thead><tr><th style="width: 12%;">Registro</th><th style="width: 15%;">Secci&oacute;n</th><th style="width: 13%">Asignatura</th><th style="width: 13%;"><center>I</center></th><th style="width: 13%;"><center>II</center></th><th style="width: 13%;"><center>III</center></th><th style="width: 13%;"><center>IV</center></th><th style="width: 8%;"><center>ANUAL</center></th></tr></thead><tbody>
<?
$lista=$Doce->RegistroDocente($dni);
while ($row = mysql_fetch_array($lista)):
echo '<tr><td><b>REGISTRO N&#176; </b>'.$row[0].'</td>
      <td>'.$row[2].' '.$row[3].' DE <b>'.$row[1].'</b></td><td>'.$row[7].'</td>
      <td><center><a style=\'color:green;\' TARGET =\'_blank\' href=\'imprimir_reginicial.php?sinatura='.$row[8].'&seccion='.$row[9].'&registro='.$row[0].'\'>Imprimir <i class=\'icon icon-zoom-in\'></i></a>&nbsp;&nbsp;&nbsp;</center></td>
      <td><center><a  style=\'color:green;display:none;\' TARGET =\'_blank\' href=\'registrainicial2.php?sinatura='.$row[8].'&seccion='.$row[9].'&registro='.$row[0].'\'>Registra <i class=\'icon icon-edit\'></i></a>&nbsp;&nbsp;&nbsp;&nbsp;
      <a  style=\'color:green;\' TARGET =\'_blank\' href=\'imprimir_reginicial2.php?sinatura='.$row[8].'&seccion='.$row[9].'&registro='.$row[0].'\'>Imprimir <i class=\'icon icon-zoom-in\'></i></a></center>
      </td>
      <td><center><a style=\'color:green;\' TARGET =\'_blank\' href=\'imprimir_reginicial3.php?sinatura='.$row[8].'&seccion='.$row[9].'&registro='.$row[0].'\'>Imprimir <i class=\'icon icon-zoom-in\'></i></a>
</center></td>';
...
&nbsp;&nbsp;&nbsp;&nbsp;
<a  style=\'color:green;display:;\' TARGET =\'_blank\' href=\'imprimir_reginicial4.php?sinatura='.$row[8].'&seccion='.$row[9].'&registro='.$row[0].'\'>Ver <i class=\'icon icon-zoom-in\'></i></a>
</center></td>';
