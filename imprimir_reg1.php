...
?>
<center><a style='color:black;font-size: 11px;'><b>REGISTRO DE NOTAS DEL II BIMESTRE-2013</b></a></center>
<?PHP
$asina = $_GET['sinatura'];
...
echo "
    <tr>
        ...
        <td style='font-size:7px'><a style='color:black;font-size: 8px;'>$row2[2]</a></td></tr>";
}
}
?>
</table>
