...
include_once 'Class/Docente.php';$profesorcitore=new Docente();
...
if($nivela==="PRIMARIA"){
    ?>
<ul class='unstyled'>
    <li style='float: left;'><code>01</code>=Matem&aacute;tica</li>             <li style='float: left;'><code>02</code>=Comunicaci&oacute;n</li>
    <li style='float: left;'><code>03</code>=Arte</li>                          <li style='float: left;'><code>04</code>=Personal Social</li>
    <li style='float: left;'><code>05</code>=Educaci&oacute;n F&iacute;sica</li><li style='float: left;'><code>06</code>=Ciencia y Ambiente</li>
    <li style='float: left;'><code>07</code>=Educaci&oacute;n Religiosa</li>    <li style='float: left;'><code>08</code>=Ingl&eacute;s</li>
    <li style='float: left;'><code>09</code>=Computaci&oacute;n</li>            <li style='float: left;'><code>10</code>=Conducta</li>
</ul>
<br>
<table class='table table-hover' id='Exportar_a_Excel'>
    <tr class='gradeX'>
        <th>N</th>
        <th>ALUMNO</th>             <th>01 MAT</th>
        <th>02 COM</th>             <th>03 ART</th>
        <th>04 PERS</th>            <th>05 EDFIS</th>
        <th>06 CCAA</th>            <th>07 REL</th>
        <th>08 INL</th>             <th>09 COMPU</th>
        <th>Promedio</th>           <th>Puntaje</th>
        <th>10 COND</th>
        <th>Cur Desaprob.</th>      <th>FN</th>
    </tr>
<?php
...
while ($prrow = mysql_fetch_array($alumnado_seccion)) {
    ...
    echo '<tr><td>'.$prrow[1].'</td><td>'.$prrow[2].' '.$prrow[3].', '.$prrow[4].' </td>';
...
?><ul class='unstyled'>
    <li style='float: left;'><code>01</code>=Matem&aacute;tica</li>         <li style='float: left;'><code>02</code>=Comunicaci&oacute;n</li>
    <li style='float: left;'><code>03</code>=Personal Social</li>           <li style='float: left;'><code>04</code>=Ciencia y Ambiente</li>
    <li style='float: left;'><code>05</code>=Informatica</li>               <li style='float: left;'><code>06</code>=Conducta</li>
</ul>
<br>
<table class='display' id='Exportar_a_Excel'style="width: 80%;">
    <tr class='gradeX'>
...
<ul class='unstyled'>
    <li style='float: left;'><code>01</code>=MATEM&Aacute;TICA</li>         <li style='float: left;'><code>02</code>=COMUNICACI&Oacute;N</li>
    <li style='float: left;'><code>03</code>=INGL&Eacute;S</li>             <li style='float: left;'><code>04</code>=CTA</li>
    <li style='float: left;'><code>05</code>=HH.GG.EE</li>                  <li style='float: left;'><code>06</code>=CIVICA</li>
    <li style='float: left;'><code>07</code>=PERSONA FF.RR.HH</li>          <li style='float: left;'><code>08</code>=EPT</li>
    <li style='float: left;'><code>09</code>=EDUCACI&Oacute;N F&Iacute;SICA</li>    <li style='float: left;'><code>10</code>=EDUCACI&Oacute;N ARTISTICA</li>
    <li style='float: left;'><code>11</code>=EDUCACI&Oacute;N RELIGIOSA</li><li style='float: left;'><code>12</code>=INFORMATICA</li>
...
echo '<tr><td style=\'font-size:14px; \'>'.$sec1row[1].'</td><td style=\'font-size:14px; \'>'.$sec1row[2].' '.$sec1row[3].' ,'.$sec1row[4].' </td>';

$registroalumnosec1=$profesorcitore->NOTASCONSOLIDADOTUTORIA4($sec1row[0]);
...
if($mat1=="0") $mat1="FN";
echo '
<td style=\'font-size:15px; \'>'.$mat1.'</td>
<td style=\'font-size:15px; \'>'.$sec1com.'</td>
<td style=\'font-size:15px; \'>'.$sec1ing.'</td>
<td style=\'font-size:15px; \'>'.$sec1ccaa.'</td>
<td style=\'font-size:15px; \'>'.$sec1hge.'</td>
<td style=\'font-size:15px; \'>'.$sec1civ.'</td>
<td style=\'font-size:15px; \'>'.$sec1ppff.'</td>
<td style=\'font-size:15px; \'>'.$sec1ept.'</td>
<td style=\'font-size:15px; \'>'.$sec1edufis.'</td>
<td style=\'font-size:15px; \'>'.$sec1arte.'</td>
<td style=\'font-size:15px; \'>'.$sec1rel.'</td>
<td style=\'font-size:15px; \'>'.$sec1inform.'</td>
<td style=\'font-size:15px; \'>'.$sec1condu.'</td>

<td style=\'font-size:15px; \'>'.$sec1arit.'</td>
<td style=\'font-size:15px; \'>'.$sec1alg.'</td>
<td style=\'font-size:15px; \'>'.$sec1geo.'</td>

<td style=\'font-size:15px; \'>'.$promedio1.'</td>
<td style=\'font-size:15px; \'>'.$secpuntajealumno1.'</td>
<td style=\'font-size:15px; \'>'.$prcursocargosec1.'</td>
<td style=\'font-size:15px; \'>'.$fnsec1.'</td>';
#reinicilializa
...
echo '<tr><td style=\'font-size:14px; \'>'.$sec2row[1].'</td><td style=\'font-size:14px; \'>'.$sec2row[2].' '.$sec2row[3].' ,'.$sec2row[4].'</td>';

$registroalumnosec2=$profesorcitore->NOTASCONSOLIDADOTUTORIA4($sec2row[0]);
...
if($mat2=="0") $mat2="FN";
echo '
<td style=\'font-size:14px; \'>'.$mat2.'</td>
<td style=\'font-size:14px; \'>'.$sec2com.'</td>
<td style=\'font-size:14px; \'>'.$sec2ing.'</td>
<td style=\'font-size:14px; \'>'.$sec2ccaa.'</td>
<td style=\'font-size:14px; \'>'.$sec2hge.'</td>
<td style=\'font-size:14px; \'>'.$sec2civ.'</td>
<td style=\'font-size:14px; \'>'.$sec2ppff.'</td>
<td style=\'font-size:14px; \'>'.$sec2ept.'</td>
<td style=\'font-size:14px; \'>'.$sec2edufis.'</td>
<td style=\'font-size:14px; \'>'.$sec2arte.'</td>
<td style=\'font-size:14px; \'>'.$sec2rel.'</td>
<td style=\'font-size:14px; \'>'.$sec2inform.'</td>

<td style=\'font-size:14px; \'>'.$sec2condu.'</td>

<td style=\'font-size:14px; \'>'.$sec2geo.'</td><td style=\'font-size:14px; \'>'.$sec2alg.'</td><td style=\'font-size:14px; \'>'.$sec2arit.'</td>

<td style=\'font-size:14px; \'>'.$promedio2.'</td><td style=\'font-size:14px; \'>'.$secpuntajealumno2.'</td>
<td style=\'font-size:14px; \'>'.$prcursocargosec2.'</td><td style=\'font-size:14px; \'>'.$fnsec2.'</td>';
#reinicilializa
...
<ul class='unstyled'>
    ...
    <li style='float: left;'><code>09</code>=EDUCACI&Oacute;N F&Iacute;SICA</li>    <li style='float: left;'><code>10</code>=EDUCACI&Oacute;N ARTISTICA</li>
    <li style='float: left;'><code>11</code>=EDUCACI&Oacute;N RELIGIOSA</li><li style='float: left;'><code>12</code>=INFORMATICA</li>
    <li style='float: left;'><code>13</code>=CONDUCTA</li></ul>
<br>
<table class='table table-hover' id='Exportar_a_Excel'>
    <tr class='gradeX'>
        <th>N</th><th>ALUMNO</th> <th>01 MAT</th><th>02 COM</th><th>03 ING</th><th>04 CTA</th>
...
echo '<tr><td style=\'font-size:14px; \'>'.$sec3row[1].'</td><td style=\'font-size:14px; \'>'.$sec3row[2].' '.$sec3row[3].' ,'.$sec3row[4].'</td>';

$registroalumnosec3=$profesorcitore->NOTASCONSOLIDADOTUTORIA4($sec3row[0]);
...
$registroalumnosec4=$profesorcitore->NOTASCONSOLIDADOTUTORIA4($sec4row[0]);
