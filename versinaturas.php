...
$nivel= $_GET['nivel'];$grado=$_GET['grado'];
?>
<div style="margin-left: 25%;margin-right: 25%;">
<center>
    <h3 style="color: red">Seleccione &Aacute;rea para ver los indicadores</h3>
    <h3 style="color: green">&Aacute;reas del <?=$grado.' grado del Nivel:'.$nivel;?></h3>
</center>
<table class="table table-hover">
<?php
$cone3an= new Conection; $cone3an->CONECT();
$query3anos=  mysql_query(
        "select codigo,asinatura from descripcionsinature where nomnivel=".$nivel." and  grado like ('%".$grado."%');");
while ($row = mysql_fetch_array($query3anos)):?>
<tr><td class='center'><a TARGET = '_blank' href='regcriterio.php?asinatura=<?=$row[0]?>'>Ver Indicadores</a></td>
<td class='center'><a style='color:#585858;' TARGET = '_blank' href='regcriterio.php?asinatura=<?=$row[0]?>'><?=$row[1]?></a></td></tr>
<?
endwhile;
?>
</table><br><br><br></div><br><br><br>
