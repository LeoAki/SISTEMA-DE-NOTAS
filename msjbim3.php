...
echo "<center><h3><b>OBSERVACIONES PARA LOS ALUMNOS DE LA SECCION: $gradoname $nameseccionnow - $nomnivelsection</b></h3><h2>- III BIMESTRE</h2></center>";
?>
    <div id="msjj">
...
<?php
        ...
        while ($row = mysql_fetch_array($whoisalumno)) {
                        echo "
                            ...
                            <td><a style='font-size:12px;'>$row[8]</a></td>
                            </tr>";
        }
?>
                    </table>
