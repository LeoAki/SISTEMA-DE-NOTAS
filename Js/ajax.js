...
function ajax_4(uno, dos, tres, cuatro, cinco) {
    ...
    $.ajax({
        type: 'GET',
        url: 'demoindicador.php?acriterio=' + uno + '&acodigo=' + dos + '&acomponente=' + tres + '&anumero=' + cuatro + '&apeso=' + cinco,
        ...
        beforeSend: function (xhr) {
            $('#modelo').html('Ejecutando');
        },
        error: function (jqXHR, textStatus, errorThrown) {
            $('#modelo').html('Ocurrio un error, vuelva a grabar');
        }
    });
}
