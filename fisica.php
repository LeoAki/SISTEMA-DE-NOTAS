    ...
    if (!isset($_SESSION['USERLNCCNOTAS']) && !$_SESSION['USERLNCCNOTAS'] instanceof Usuario) {
        ...
        <body>
            ...
            <div style="margin-left: 3%;margin-right: 3%;" id="primer">
                <center><h4 style="color: green">SOLO PROFESORES DE EDUCACION FISICA IIB</h4></center>
                <?php
                ...
                ?>
                        <table class="table table-hover">
                            <tr class="gradeU">
                                ...
                                <td style="width: 67%;color: peru;text-transform: uppercase;"><b>Profesor de Educaci&oacute;n F&iacute;sica</b></td>
                            </tr>
                            <?
                            $area = 3;
