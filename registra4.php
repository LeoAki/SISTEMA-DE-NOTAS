...
<body>
<?php require_once 'Class/Component.php';require_once 'Class/Indicador.php';require_once 'Class/RegistroAlumno4.php';
$INDICAXD= new Indicador();$REGISTROALUMNO= new RegistroAlumno4();$_COOKIE["valuecombix"]; ?> <center><h3 style="color: green">Registro De Notas por asignatura- IV BIMESTRE</h3>
<?PHP
...
?> </table></center>
<table class="display">
<?php $COMPONENTE=new Component();$listar=$COMPONENTE->LISTAR4($asina);
...
?>
<form name="frmregistro" method="post" action="registra4.php?GRABAR=0">
...
<?php
$reAl = new RegistroAlumno4();$listaalumnado=$reAl->ListaAlumnoSeccion($seccion);
...
$lista=$INDICAXD->LISTAR($ro[0]);
    ...
    $listadice=RegistroAlumno4::LISTAR4($alumno[4].$seccion.$asina);
