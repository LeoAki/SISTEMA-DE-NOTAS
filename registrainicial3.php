...
$listadice=  $REGISTROALUMNO->LISTAR_3($alumno[4].$seccion.$asina);
...
echo "<td>
        <input type='text' style='width:80%;'  value='$valorpromedio' id='$alumno[0]promedio$ro[1]' name='$alumno[0]promedio$ro[1]' maxlength=2;/>
      </td>";
    }

echo "<td><input type='text' style='width:80%;' id='$alumno[0]pb' name='$alumno[0]pb'  value='$pb' maxlength=2/></td>";
echo "</tr>";
}
?>
</table>
