...
<html>
<head>
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8"><link rel="icon" href="Css/images/favicon.ico"><title>LNCC ONLINE--Dirigite a tus alumno</title>
...
include_once 'Class/Docente.php';include_once 'Class/ALUMNO_SECCION.php';
...
<center><h3 style="color: green">Escriba el comentario u observaci&oacute;n sobre el desempe&ntilde;o de sus alumnos de tutor&iacute;a en el presente Bimestre. IV</h3></center>
    <?
    ...
    <center><h4 style='color: peru'>SECCION: <?=$gradoname.' '.$nameseccionnow.' '.$nomnivelsection?></h4><h5 style='color: peru'>TUTOR: <?=$apellidosdocentenow?></h5></center>
    <a TARGET = '_blank' href='printmesaje.php' class='btn btn-primary'>Ver como impresi&oacute;n</a>
<br>
  <form id="frmmensaje" method="post" action="regmensaje.php?GRABAR=0">
    <fieldset><legend>A mis Alumnos:</legend>
    <table class="table table-hover">
    <tr class="gradeU">
     <td style="display: none;"></td><td style="width: 3%;color: peru;text-transform: uppercase;"><b>N</b></td><td style="width: 30%;color: peru;text-transform: uppercase;"><b>Alumno</b></td><td style="width: 56%;color: peru;text-transform: uppercase;"><b>Observaci&oacute;n</b></td>
    </tr>
<?
...
?>
    ...
    <td><input type='text' style='width:100%' value='<?=$row[7]?>' id='txtmensaje<?=$row[1]?>' name='txtmensaje<?=$row[1]?>'/></td>
    </tr>
<?
}
echo $row[6];
...
<center><div class="form-actions"><button type="submit"class="btn btn-primary">GRABAR/ACTUALIZAR LOS MENSAJES</button></div></center><br><br><br><br>
</form>
</div>
