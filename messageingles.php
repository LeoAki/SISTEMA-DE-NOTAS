...
<link rel="icon" href="Css/images/favicon.ico"><title>Mensajes::Ingles</title>
...
for($x =1 ; $x <= 35; $x++){//recorremos todos los alumnos,se recuperan cada uno de los datos del form siempre y cuando se hayan enviado, de lo contrario los omite
    ...
    $AlSECIONPF->setMESSAGEINGLES(htmlentities($_REQUEST['txtnota1'.$x],ENT_QUOTES,"UTF-8"));
    $AlSECIONPF->GRABAR_INGLES();
}
    echo '<script>window.location = \'messageingles.php\'</script>';
}
//-------------------------------------------------------------------------------------
?>
<div style="margin-left: 3%;margin-right: 3%;" id="primer">
<center><h4 style="color: green">SOLO PROFESORES DE INGLES IVB</h4></center>
<?php
...
?>
<form id="frmmensaje" method="post" action="messageingles.php?GRABAR=1">
<fieldset>
<table class="table table-hover">
    ...
    <td style="width: 67%;color: peru;text-transform: uppercase;"><b>Profesor de Ingl&eacute;s</b></td>
    </tr>
<?
$area=4;
