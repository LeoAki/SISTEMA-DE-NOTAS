...
?>
<center><a style='color:black;font-size: 11px;'><b>REGISTRO DE NOTAS DEL II BIMESTRE-2014</b></a></center>
<?PHP
$asina = $_GET['sinatura'];
...
?>
<tr>
    <td class='center' style='font-size:7px'><a style='color:black;font-size: 8px;'>[<?=$row[1].$row2[3]?>]</a></td>
    <td style='font-size:7px'><a style='color:black;font-size: 8px;'><?=$row2[2]?></a></td>
</tr>
<?}
}
?>
...
<thead>
<tr>
    <td><a style='color:black;font-size: 10px;'><b>N &#176;</b></a></td>
    <td style="width: 32%;"><a style='color:black;font-size: 10px;'><b>ALUMNO</b></a></td>
<?php
...
$listath=$INDICAXD->LISTAR($roth[0]);
    ...
    <? endwhile; ?>
    <td><a style='color:black;font-size: 11px;'><b>P<?=$roth[1]?></b></a></td><?
endwhile;
?>
    <td><a style='color:black;font-size: 11px;'><b>PB</b></a></td>
<?php
if($variable2=="PRIMARIA"){?> <td style='font-size:11px;color:black;'><b>PB</b></td><?} ?>
</tr>
</thead>
<?php
...
<?  $td=$COMPONENTE->LISTAR2($asina);
    while ($ro = mysql_fetch_array($td)) {
        ...
        while ($row22 = mysql_fetch_array($lista)) {
            ...
            ?><td><a style='color:black;font-size: 10px;'><?=$notita?></a></td><?
        }
if($promedio=="-2") $promedio="EX";
if($promedio=="-1") $promedio="R";
if($promedio=='0') $promedio="FN";
            ?><td><a style='color:black;font-size: 10px;'><b><?=$promedio?></b></a></td><?
    }

if($pbb=="-2") $pbb="EX";
if ($pbb=="-1") $pbb="R";
if($pbb==='0') $pbb="FN";
            ?><td><a style='color:black;font-size: 11px;'><b><?=$pbb?></b></a></td><?
...
<br><br>
<center>
-------------------------------------------<br><a style='color:black;font-size: 9px;'>Prof: <?php echo $paternodocente.' '.$maternodocente.' ,'.$nombresdocente;?><br>
