...
<html>
    <head>
        ...
        <title>LNCC ONLINE--Registro De Notas :D</title>
<!----------------------------------BOOTSTRAP--css-------------------------------------------------->
...
<td>
<center>
<a  TARGET = '_blank' href='registra.php?sinatura=".$row[8]."&seccion=".$row[9]."&registro=".$row[0]."'><i class='icon-eye-open'></i></a>
<a  TARGET = '_blank' href='imprimir_reg.php?sinatura=".$row[8]."&seccion=".$row[9]."&registro=".$row[0]."'><i class='icon-search'></i></a>
</center>
</td>
<td>
<center>
<a  TARGET = '_blank' href='registra1.php?sinatura=".$row[8]."&seccion=".$row[9]."&registro=".$row[0]."'><i class='icon-eye-open'></i></a> |||
<a  TARGET = '_blank' href='imprimir_reg1.php?sinatura=".$row[8]."&seccion=".$row[9]."&registro=".$row[0]."'><i class='icon-search'></i></a>
</center>
</td>
<td>
<center>
