...
<br><br><i class='alert alert-success'><b>Asignatura:</b>$rowworksina[5]-3er-Bimestre</i>
</a>";}
...
$liscompte =$componew->LISTAR3($idsinata);
    ...
    while ($rowindidorr = mysql_fetch_array($lisindidor)) {
        ...
        #empieza ver notas
            if($viewniveluser=="INICIAL"){
                $viewregin=$regininew->LISTAR_3($alumno_seccionm.$idsectionz.$idsinata);
            ...
            if($viewniveluser!="INICIAL"){
                $viewregi2=$regalumsecprinew->LISTAR3($alumno_seccionm.$idsectionz.$idsinata);
                while ($rowviewnotas2 = mysql_fetch_array($viewregi2)) {
                    $valuecel2=$rowcompte[1].$rowindidorr[3];
                    $showno2=$rowviewnotas2["3p$valuecel2"];
                    if($showno2=="0"){
                        $showno2="FN";
                    }
                    echo "<td><i>".$showno2."</i></td>" ;
                    $valorpromedioview2=$rowviewnotas2["3promedio".$rowcompte[1]];
                    $pbview2=$rowviewnotas2["3pb"];
                }
            }
echo "</tr>";
    }
