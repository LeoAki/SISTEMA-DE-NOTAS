...
#------------------------------------------------------------------curso a cargo
$prcursocargo=$profesorcitore->cursocargonormalpr($prmate, $prcursocargo,$prregistro[1]);
$prcursocargo=$profesorcitore->cursocargonormalpr($prcomuni, $prcursocargo,$prregistro[1]);
$prcursocargo=$profesorcitore->cursocargonormalpr($prarte, $prcursocargo,$prregistro[1]);
$prcursocargo=$profesorcitore->cursocargonormalpr($prpersoc, $prcursocargo,$prregistro[1]);
$prcursocargo=$profesorcitore->cursocargonormalpr($predufis, $prcursocargo,$prregistro[1]);
$prcursocargo=$profesorcitore->cursocargonormalpr($predurel, $prcursocargo,$prregistro[1]);
$prcursocargo=$profesorcitore->cursocargonormalpr($pring, $prcursocargo,$prregistro[1]);
$prcursocargo=$profesorcitore->cursocargonormalpr($prcomp, $prcursocargo,$prregistro[1]);
$prcursocargo=$profesorcitore->cursocargonormalpr($prccaa, $prcursocargo,$prregistro[1]);
...
<table class='table table-hover' id='Exportar_a_Excel'>
    <tr class='gradeX'>
        <th>N</th><th>ALUMNO</th><th>01 MAT</th><th>02 COM</th><th>03 ING</th><th>04 CTA</th>
                                  ...
                                  <th>PROMEDIO</th><th>PUNTAJE</th><th>CURSOS DESAPROBADOS</th><th>FN</th>
    </tr>
";
$alumnado_seccionSEC1=$profesorcitore->ALUMNOSDEMITUTORIA2($seccion);$count_alumn=0;
#variables de notas aprobatorias
...
while ($sec1registro = mysql_fetch_array($registroalumnosec1)) {
    #matematicas
    if($sec1registro[2]=='Aritmetica'){
        $sec1arit=$sec1registro[3];
        #$prprovmate=$profesorcitore->aprobadoareanormal($prmate, $prprovmate);
    }
    if($sec1registro[2]=='Algebra'){
        $sec1alg=$sec1registro[3];
    }
    if($sec1registro[2]=='Geometria'){
        $sec1geo=$sec1registro[3];
    }
    if($sec1registro[2]=='Comunicacion'){
        $sec1com=$sec1registro[3];
    }
...
<table class='table table-hover' id='Exportar_a_Excel'>
    <tr class='gradeX'>
        <th>N</th><th>ALUMNO</th><th>01 MAT</th><th>02 COM</th><th>03 ING</th><th>04 CTA</th>
                                  ...
                                  <th>PROM.</th><th>PUNT.</th><th>CUR. DESAP.</th>
    </tr>
";
...
while ($sec2registro = mysql_fetch_array($registroalumnosec2)) {
    #matematicas
    if($sec2registro[2]=='Aritmetica'){
        $sec2arit=$sec2registro[3];
        #$prprovmate=$profesorcitore->aprobadoareanormal($prmate, $prprovmate);
    }
...
";
#reinicilializa
$prcursocargosec2=0;$secpuntajealumno2=0;$promedio2=0;$sec2arit=0;$sec2alg=0;
...
<table class='table table-hover' id='Exportar_a_Excel'>
    <tr class='gradeX'>
        <th>N</th><th>ALUMNO</th> <th>01 MAT</th><th>02 COM</th><th>03 ING</th><th>04 CTA</th>
                                  ...
                                  <th>QUI</th><th>FIS</th>
                                  <th>PROM.</th><th>PUNT.</th><th>CUR. DES.</th>
    </tr>
";
$alumnado_seccionSEC3=$profesorcitore->ALUMNOSDEMITUTORIA2($seccion);$count_alumn=0;
#variables de notas aprobatorias
...
while ($sec3registro = mysql_fetch_array($registroalumnosec3)) {
    #matematicas
    if($sec3registro[2]=='TRIGONOMETRIA'){
        $sec3tri=$sec3registro[3];
    }
    if($sec3registro[2]=='ALGEBRA'){
        $sec3alg=$sec3registro[3];
    }
    if($sec3registro[2]=='GEOMETRIA'){
        $sec3geo=$sec3registro[3];
    }
    if($sec3registro[2]=='COMUNICACION'){
        $sec3com=$sec3registro[3];
    }
    if($sec3registro[2]=='INGLES'){
        $sec3ing=$sec3registro[3];
    }
    if($sec3registro[2]=='QUIMICA'){
        $sec3quimica=$sec3registro[3];
    }
    if($sec3registro[2]=='FISICA'){
        $sec3fisica=$sec3registro[3];
    }
...
";
#reinicilializa
$prcursocargosec3=0;$secpuntajealumno3=0;$promedio3=0;$sec3alg=0;$sec3tri=0;
...
while ($sec4registro = mysql_fetch_array($registroalumnosec4)) {
    #matematicas
    if($sec4registro[2]=='TRIGONOMETRIA'){
        $sec4tri=$sec4registro[3];
    }
    if($sec4registro[2]=='GEOMETRIA'){
        $sec4geo=$sec4registro[3];
    }
    if($sec4registro[2]=='ARITMETICA'){
        $sec4ari=$sec4registro[3];
    }
    if($sec4registro[2]=='COMUNICACION'){
        $sec4com=$sec4registro[3];
    }
    if($sec4registro[2]=='INGLES'){
        $sec4ing=$sec4registro[3];
    }
    if($sec4registro[2]=='BIOLOGIA'){
        $sec4quimica=$sec4registro[3];
    }
    if($sec4registro[2]=='FISICA'){
        $sec4fisica=$sec4registro[3];
    }
...
";
#reinicilializa
$prcursocargosec4=0;$secpuntajealumno4=0;$promedio4=0;$sec4ari=0;$sec4tri=0;
...
";
#reinicilializa
$prcursocargosec2=0;$secpuntajealumno2=0;$promedio2=0;$sec2tri=0;$sec2alg=0;
$sec2geo=0;$mat2=0;$sec2com=0;$sec2ing=0;$sec2ccaa=0;$sec2hge=0;$sec2civ=0;
$sec2ppff=0;$sec2ept=0;$sec2edufis=0;$sec2arte=0;$sec2rel=0;$sec2inform=0;$sec2condu=0;
