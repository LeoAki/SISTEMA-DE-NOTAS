...
<center><h3 style="color: green">BOLETA DE NOTAS</h3></center>
            <a class="text-error">SECCI&Oacute;N:</a><?php echo "<a class='text-info'><i> $gradoedu &#176; $namesec </i><b>NIVEL: </b><i>$niveledu</i><br></a>"; ?>
            <a class="text-error">ALUMNO: </a><?php echo "<a class='text-info'>$paterno $materno ,$nombrestodos</a>"; ?>
            <center>
...
echo"<tr>";
    echo "<td>$rowsinaturegene[4]</td>";#ASIGNATURA
