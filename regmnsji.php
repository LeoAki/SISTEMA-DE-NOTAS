...
<html>
<head>
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8"><link rel="icon" href="Css/images/favicon.ico"><title>LNCC ONLINE--Dirigite al PP.FF</title>
...
<body>
<?php
require_once 'Includes/navegador.php'; include_once 'Class/Conection.php';
...
for($x =1 ; $x <= 35; $x++){//recorremos todos los alumnos,se recuperan cada uno de los datos del form siempre y cuando se hayan enviado, de lo contrario los omite
    ...
    $AlSECIONPF->setCPF5($_REQUEST['txtnota5'.$x]);    $AlSECIONPF->setCPF6($_REQUEST['txtnota6'.$x]);
    $AlSECIONPF->setCPF7($_REQUEST['txtnota7'.$x]);    $AlSECIONPF->setCPF8($_REQUEST['txtnota8'.$x]);
...
<article><section>1. <i>Asiste puntualmente a las reuniones y entrevistas del aula.</i></section><section>2. <i>Se esmera en la presentacion e higiene personal del ni&ntilde;o.</i></section><section>3. <i>Apoya permanentemente con las tareas de su ni&ntilde;o.</i></section><section>4. <i>Incentiva la participaci&oacute;n de su ni&ntilde;o en las diferentes actividades.</i></section><section>5. <i>Se interesa en el avance y progreso de su ni&ntilde;o.</i></section><section>6. <i>Colabora con las necesidades del aula.</i></section><section>7. <i>Firma diaramente la Bit&aacute;cora.</i></section><section>8. <i>Recoge el informe del progreso del ni&ntilde;o en la fecha indicada.</i></section><section>9. <i>Asiste a la Escuela de Familia.</i></section></article>
<?php
...
<table class="table table-hover">
    ...
    <td style="width: 7%;color: peru;text-transform: uppercase;"><b>9</b></td></tr>
<?php
